/* ============================================================================
   ...
   const STORAGE_KEYS = {
    ...
    settingsTimestamp: "taskmaster_settings_timestamp",
    profilePicUrl: "taskmaster_profile_picture_url",
  }
  ...
  function saveSettings(settingsPatch) {
    ...
    localStorage.setItem(STORAGE_KEYS.settingsTimestamp, Date.now().toString())
    return updated
  }
